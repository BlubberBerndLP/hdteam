...
_role1names = ["GrandTheftAltis", "Fun Life"]; //In white
_role2 = "Website";
_role2names = ["Forum.GrandTheftAltis.net"]; 
_role3 = "Teamspeak IP";
_role3names = ["GrandTheftAltis.net"];
_role4 = "Support";
_role4names = ["Du hast Fragen", "oder ein Problem?", " Wir helfen dir via Teamspeak"];
_role5 = "Bitte beachtet";
_role5names = ["Dies ist ein Rollenspielserver", "Es gelten besondere Regeln", "Infos auf der Webseite"];
_role6 = "Server Restarts";
_role6names = ["00:00", "04:00", "08:00", "12:00", "16:00", "20:00", "", ""];
_role7 = "Server Version";
_role7names = ["1.2"];
_role8 = "Besonderer Dank an unsere";
_role8names = ["Supporter","und das Team"];
_role9 = "Server Admins";
_role9names = ["Joshua", "Hans M"];
_role10 = "Inhaber";
_role10names = ["Marlon", "Rene"];

{
	uisleep 2;
	_memberFunction = _x select 0;
	_memberNames = _x select 1;
	_finalText = format ["<t font='PuristaMedium' size='0.55' color='#0CA2F3' align='right'>%1<br /></t>", _memberFunction];
