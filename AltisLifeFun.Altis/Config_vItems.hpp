...
class VirtualShops {
    ...
    class med_market {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "lockpick", "redgull", "tbacon", "toolkit", "fuelFull", "peach", "defibrillator" };
    };
    ...
    class rebel {
        ...
        license = "rebel";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "kabelbinder", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
