...
switch(playerSide)do{
 ...
 case 2: { _rang = "Polizei Meister"; };
 case 3: { _rang = "Polizeihauptmeister"; };
 case 4: { _rang = "Polizeiobermeister"; };
 case 5: { _rang = "Polizeikommisar"; };
 case 6: { _rang = "SEK"; };
 case 7: { _rang = "Ausbilder"; };
 case 8: { _rang = "Commissioner"; };
 default { _rank = "Error";};
 };
 _marke = "marke_cop";
 _org = "Polizei Altis";
 ...
 case 3: { _rang = "Notfallsanitäter"; };
 case 4: { _rang = "Notarzt"; };
 case 5: { _rang = "Feuerwehr-Anwärter"; }; 
 case 6: { _rang = "Feuerwehr"; }; 
