...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "kabelbinder", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" }; //Array of virtual items that can be saved on your player.
...
/* System Settings */
    ...
    respawn_timer = 80; //How many seconds a player should wait, before being able to respawn. Minimum 5 seconds.
    ...
    fuel_cost = 10000; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    ...
    gang_price = 45000; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    ...
    revive_fee = 1000000; //Revive fee that players have to pay and medics only EMS(independent) are rewarded with this amount.
    ...
    paycheck_cop = 10000000; //Payment for cops
    paycheck_civ = 10000000; //Payment for civillians
    paycheck_med = 10000000; //Payment for medics
